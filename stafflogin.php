...
<body>
    ...
    <div id="content-container">
        ...
        <p>Please login first. Only authorized user are allow to access to this page</p>
        <form action="stafflogin2.php" method="post">
            <input type="text" placeholder="Username" name="staffID" required>
            <input type="password" placeholder="Password" name="Staffpassword" required>
